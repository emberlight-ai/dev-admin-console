...
export async function PATCH(
  ...
  const { data, error } = await supabaseAdmin
    ...
    .update(updates)
    .eq('userid', userid)
    .select('userid,username,profession,age,gender,personality,zipcode,location_name,longitude,latitude,notification_enabled,location_enabled,bio,storyline,avatar,updated_at')
    .maybeSingle();
